...
function displaySection(link, section) {
  ...
  lnk.onclick = (event) => {
    ...
    if (mq.matches) {
      // show the back button when a link is clicked in responsive mode .
      ...
      let aboutMeIntroSection = document.querySelector("#intro-section");
    ...
    let jerjer = lnk.parentElement.children;
    for (j of jerjer) {
